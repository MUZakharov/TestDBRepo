...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Resume in XML format.' , @level0type=N'SCHEMA',@level0name=N'HumanResources', @level1type=N'TABLE',@level1name=N'JobCandidate', @level2type=N'COLUMN',@level2name=N'Resume'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Resumes submitted to Human Resources by job applicants.' , @level0type=N'SCHEMA',@level0name=N'HumanResources', @level1type=N'TABLE',@level1name=N'JobCandidate'
GO
