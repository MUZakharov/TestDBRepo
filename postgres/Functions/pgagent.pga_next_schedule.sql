CREATE FUNCTION "pgagent"."pga_next_schedule"( in integer, in timestamp with time zone, in timestamp with time zone, in ARRAY, in ARRAY, in ARRAY, in ARRAY, in ARRAY)
